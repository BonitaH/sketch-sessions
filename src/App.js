...
class Expressions extends React.Component {
  ...
  handleOptionChange(changeEvent) {
    ...
    this.setState({selectedExpression: changeEvent.target.value});
  }
        ...
        <div className="row">
          <div className=".col-xs-12 .col-sm-12">
            ...
            <form onSubmit={this.handleFormSubmit.bind(this)}>
              ...
              <button className="btn btn-default btn-lg saveButton" type="submit">Save</button>
            </form>
          </div>
        </div>
      </div>
    ...
    return (
      <div>
        ...
        {this.state.clickButton
          ? <ImageOverlay close={this.onClose.bind(this)} gender="female" expression="sad"/>
          : null}
      </div>
    );
  }
...
class ImageOverlay extends React.Component {
  ...
  previous() {
    this.count = 0;
    this.setState({
      imageIndex: (this.state.imageIndex - 1 < 0)
  ...
  next() {
    this.count = 0;
    this.setState({
      imageIndex: (this.state.imageIndex + 1 > this.state.selection.length - 1)
        ? 0
        : this.state.imageIndex + 1
    });
  }
  ...
  render() {
    return (
      ...
      <div id="overlay" className="overlay" style={{
        ...
        <img src={this.state.selection[this.state.imageIndex]} className="img-responsive" style={{
          "height": "92%",
          "width": "100%",
          "position": "relative",
          "align": "center",
          "object-fit": "contain"
        }} alt="overlay"/> {/*<input id="switchEvery" type="text" defaultValue={this.switchEvery} onBlur={this.changeSwitch.bind(this)}/>*/}
        ...
        {/*<div className="btn-group .col-xs-12 .col-md-8">
                 <button type="button" className="btn btn-default btn-lg button3" onClick={this.previous.bind(this)}>Previous</button>
                 <button type="button" className="btn btn-default btn-lg button3" onClick={this.props.close}>STOP</button>
                 <button type="button" className="btn btn-default btn-lg button3" onClick={this.next.bind(this)}>Next</button>
              </div>*/}
